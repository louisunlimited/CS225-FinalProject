...
3. Police Training Simulator
    - Input:
        ...
        A pair of earth coordinates (latitude before longitude, to 4 decimal) as the starting point. We are using k-d tree (NNS) to find the best match for your inputs, so technically we do not have hard restrictions on your input. But for the best result please try to be as accurate as possible and stay within the San Francisco Area.
